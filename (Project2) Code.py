...
while True:
        ...
        if (pulse>100 or pulse<60): #setting the if condition for sending sms through fast2sms
            ...
            r = requests.get('https://www.fast2sms.com/dev/bulk?authorization=CT8hIwZG0p7ROvsZ1xg9KH9SwOfAVjswzoEx0vugk6axVZbI9Tyk7bVao0Gv&sender_id=FSTSMS&message=Pulse%20is%20not%20normal&language=english&route=p&numbers=9********')
            print(r.status_code)
        if not success:
            print("Not connected txo IoTF")
        time.sleep(2)
